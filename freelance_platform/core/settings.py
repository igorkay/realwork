...
SECRET_KEY = 'django-insecure-5v&4!(32om7*xrf)=p!0uz74s2e!zz86knl0(asz-$py6anaui'
...
# Настройка REST Framework для работы с JWT
REST_FRAMEWORK = {
...
# Настройка времени жизни токенов (необязательно, но полезно)
